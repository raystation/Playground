...
include('header.php'); ?>
	...
	<div class="button">
		<h3 onclick="languagechange()">HIT ME 1</h3>
	</div>
	...
	<div class="wrap center">
		...
		<nav>
			...
			<ul class="english">
				...
				<li>find</li>
				<li>portfolio</li>
				<li><a href="spanish-english-2.php">page</a></li>
			</ul>
			...
			<ul class="spanish hidden">
				...
				<li>contacto</li>
				<li>encontrar</li>
				<li><a href="spanish-english-2.php">cartera</a></li>
			</ul>
	...
	<div class="wrap">
		...
		<div class="spanish hidden">
			<p>
				Fondo de Riker es explorado por primera vez en el episodio de la segunda temporada de The Icarus Factor. En el episodio, el ausente padre de Riker, Kyle, visita la empresa para ofrecer a su hijo el mando de la USS Aries, que se niega Riker. Nos enteramos de que Riker creci&oacute; en Valdez, Alaska, que su madre, Elizabeth, muri&oacute; cuando &eacute;l tenia dos a&ntilde;os, y que fue criado por su padre hasta la edad de 15, cuando &eacute;l se fue de casa. En el episodio, Riker no habia hablado con su padre durante 15 a&ntilde;os, pero se las arreglan para remendar parcialmente su relaci&oacute;n a lo largo de un juego de combate de artes marciales llamado Anbo-jitsu. En el episodio "Lower Decks" un camarero en el Ten Forward equivocadamente afirma que Riker es canadiense. De acuerdo con el episodio de Voyager "Death Wish" (que Riker hizo una aparici&oacute;n especial en el), los ancestros distantes de Riker tambi&eacute;n vivian en los Estados Unidos: durante la Guerra Civil Americana, su antepasado el coronel Thaddius Riker luch&oacute; del lado de la Uni&oacute;n, como oficial en el 102 Regimiento de Infanteria de Nueva York durante la campa&ntilde;a de Atlanta.
			</p>
			<p>
				Fondo de Riker es explorado por primera vez en el episodio de la segunda temporada de The Icarus Factor. En el episodio, el ausente padre de Riker, Kyle, visita la empresa para ofrecer a su hijo el mando de la USS Aries, que se niega Riker. Nos enteramos de que Riker creci&oacute; en Valdez, Alaska, que su madre, Elizabeth, muri&oacute; cuando &eacute;l tenia dos a&ntilde;os, y que fue criado por su padre hasta la edad de 15, cuando &eacute;l se fue de casa. En el episodio, Riker no habia hablado con su padre durante 15 a&ntilde;os, pero se las arreglan para remendar parcialmente su relaci&oacute;n a lo largo de un juego de combate de artes marciales llamado Anbo-jitsu. En el episodio "Lower Decks" un camarero en el Ten Forward equivocadamente afirma que Riker es canadiense. De acuerdo con el episodio de Voyager "Death Wish" (que Riker hizo una aparici&oacute;n especial en el), los ancestros distantes de Riker tambi&eacute;n vivian en los Estados Unidos: durante la Guerra Civil Americana, su antepasado el coronel Thaddius Riker luch&oacute; del lado de la Uni&oacute;n, como oficial en el 102 º Regimiento de Infanteria de Nueva York durante la campa&ntilde;a de Atlanta.
			</p>
		</div>
